defmodule Rummage.EctoTest do
  ...
  test "rummage call with sort and assoc params returns the correct results" do
    ...
    # Test ordering
    [products_1, products_2, products_3, products_4] = Enum.chunk_every(products, 2)
  ...
  test "rummage call with search and search_type lteq returns the correct results" do
    ...
    assert rummage == %{
             search: %{
               price: %{search_type: :lteq, search_term: 10, search_expr: :where, assoc: []}
             }
           }
  end
  ...
  test "rummage call with search and search_type eq returns the correct results" do
    ...
    assert rummage == %{
             search: %{
               price: %{search_type: :eq, search_term: 10, assoc: [], search_expr: :where}
             }
           }
  end
  ...
  test "rummage call with search and search_type gteq returns the correct results" do
    ...
    assert rummage == %{
             search: %{
               price: %{search_type: :gteq, search_term: 10, assoc: [], search_expr: :where}
             }
           }
  end
  ...
  test "rummage call with search and assoc params returns the correct results" do
    ...
    rummage = %{
      search: %{name: %{assoc: [inner: :category], search_type: :like, search_term: "1"}}
    }
  ...
  test "rummage call with search, sort and paginate" do
    ...
    assert rummage == %{
             search: %{
               price: %{search_type: :lteq, search_term: 10, assoc: [], search_expr: :where}
             },
  ...
  test "rummage call with multiple associations in assocs search" do
    ...
    assert Enum.all?(
             ...
             &(Repo.preload(&1.category, :parent_category).parent_category.name =~
                 "Parent Category")
           )
  ...
  test "rummage call with multiple associations in assocs search and assoc sort" do
    ...
    rummage = %{
      ...
      sort: %{assoc: [inner: :category, inner: :parent_category], field: :name, order: :asc}
    }
  ...
  test "rummage call with multiple associations in assocs sort" do
    ...
    rummage = %{
      paginate: %{page: 1},
      search: %{
        name: %{assoc: [{:inner, :category}], search_type: :like, search_term: "Category"}
      },
      sort: %{assoc: [{:inner, :category}, {:inner, :parent_category}], field: :name, order: :asc}
    }
  ...
  test "rummage call with rummage_field for search" do
    ...
    rummage = %{
      search: %{created_at_year: %{search_type: :eq, search_term: Date.utc_today().year}}
    }
