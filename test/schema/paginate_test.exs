defmodule Rummage.Schema.PaginateTest do
  use ExUnit.Case
  doctest Rummage.Schema.Paginate
  ...
  test "rummage" do
    ...
    {query, paginate} = Rummage.Ecto.Product
    ...
    assert paginate == %Rummage.Ecto.Rummage.Paginate{max_page: 2, page: 2, per_page: 4, total_count: 8}
  end
end
